...
# Deletes Entel* assets from web\__themes__\, resets custom-themes.json,
...
Write-Host "Removing Entel* assets ..."
Get-ChildItem $tfThemesWeb -Filter 'Entel*' -File -ErrorAction SilentlyContinue |
